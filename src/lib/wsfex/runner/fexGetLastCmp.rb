  ...
  module Runner
    class FEXGetLastCmp < Base
      def main
        ...
        WSFEX::Client.getLastCmp(ticket, @punto_vta, @tipo_cbte, @options.log)
      end
...
wsfe FEGetLastCmp 19 0001 --cuit 20123456780
wsfe FEGetLastCmp 19 0001 --cuit 20123456780 --test
wsfe FEGetLastCmp 19 0001 --cuit 20123456780 --test --out ./resultado.ini
__EOD__
      end
    end
  end
