.. index:: FECAEASolicitar

FECAEASolicitar
===============

Solicita un CAEA para un determinado período. El CAEA podrá ser solicitado dentro de los 5 (cinco) días corridos anteriores al comienzo de cada quincena. La primera quincena abarca del primero al quince de cada mes, y la segunda desde el dieciseis hasta el último día del mes.
...
::
  ...
  wsfe FECAEASolicitar <Período> <Quincena> <opciones>
