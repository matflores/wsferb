.. index:: FEParamGetTiposIva

FEParamGetTiposIva
==================

Devuelve la lista de alícuotas de IVA habilitadas.
...
::
  ...
  wsfe FEParamGetTiposIva <opciones>
...
La respuesta contiene un registro de tipo "1" por cada alícuota de IVA habilitada.
